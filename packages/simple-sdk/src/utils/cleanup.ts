...
// Updated CleanupManager without relying on Machine.id and Volume.id
export class CleanupManager {
    constructor(private apps: App[], private logger: Logger) {}
...
interface Machine {
  ...
  status: string;
  region: string;
  volume_names?: string[]; // Assuming volume_names are part of the machine details
}