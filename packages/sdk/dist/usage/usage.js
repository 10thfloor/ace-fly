import { FlySDK } from "../sdk/core/FlySDK.js";
...
class FlyDeployment extends FlySDK {
    constructor(context) {
        ...
        const devDomainCertificate = new FlyCertificate(this.stack, "dev-certificate", {
            name: "my-certificate",
            domains: [devDomain],
        });
        ...
        const apiAutoScaling = new FlyAutoScalingConfig(this.stack, "api-auto-scaling", {
            minMachines: 1,
            maxMachines: 5,
            targetCPUUtilization: 70,
            scaleToZero: true,
        });
        const webAutoScaling = new FlyAutoScalingConfig(this.stack, "web-auto-scaling", {
            minMachines: 1,
            maxMachines: 5,
            targetCPUUtilization: 70,
            scaleToZero: true,
        ...
        const loadBalancingConfig = new FlyLBConfig(this.stack, "load-balancing-config", {
        ...
        const devApp = new FlyIoApp(this.stack, "dev-app", {
            name: "my-dev-app",
            domain: devDomain,
            certificate: devDomainCertificate,
            secrets: [secret],
